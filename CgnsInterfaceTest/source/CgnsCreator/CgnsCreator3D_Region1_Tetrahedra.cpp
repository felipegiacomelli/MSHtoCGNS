...
TestCase(Elements) {
    ...
    checkEqual(tetrahedrons[ 0][0], 13); checkEqual(tetrahedrons[ 0][1],  9); checkEqual(tetrahedrons[ 0][2], 10); checkEqual(tetrahedrons[ 0][3], 12);
    checkEqual(tetrahedrons[ 1][0], 13); checkEqual(tetrahedrons[ 1][1], 11); checkEqual(tetrahedrons[ 1][2],  9); checkEqual(tetrahedrons[ 1][3], 12);
    checkEqual(tetrahedrons[ 2][0],  8); checkEqual(tetrahedrons[ 2][1], 13); checkEqual(tetrahedrons[ 2][2], 10); checkEqual(tetrahedrons[ 2][3], 12);
    checkEqual(tetrahedrons[ 3][0], 13); checkEqual(tetrahedrons[ 3][1],  8); checkEqual(tetrahedrons[ 3][2], 11); checkEqual(tetrahedrons[ 3][3], 12);
    checkEqual(tetrahedrons[ 4][0],  0); checkEqual(tetrahedrons[ 4][1],  3); checkEqual(tetrahedrons[ 4][2],  8); checkEqual(tetrahedrons[ 4][3], 12);
    checkEqual(tetrahedrons[ 5][0],  8); checkEqual(tetrahedrons[ 5][1],  7); checkEqual(tetrahedrons[ 5][2],  4); checkEqual(tetrahedrons[ 5][3], 13);
    checkEqual(tetrahedrons[ 6][0],  5); checkEqual(tetrahedrons[ 6][1],  9); checkEqual(tetrahedrons[ 6][2],  1); checkEqual(tetrahedrons[ 6][3], 10);
    checkEqual(tetrahedrons[ 7][0],  9); checkEqual(tetrahedrons[ 7][1],  2); checkEqual(tetrahedrons[ 7][2],  1); checkEqual(tetrahedrons[ 7][3], 12);
    checkEqual(tetrahedrons[ 8][0],  3); checkEqual(tetrahedrons[ 8][1],  7); checkEqual(tetrahedrons[ 8][2],  8); checkEqual(tetrahedrons[ 8][3], 11);
    checkEqual(tetrahedrons[ 9][0], 13); checkEqual(tetrahedrons[ 9][1],  7); checkEqual(tetrahedrons[ 9][2],  6); checkEqual(tetrahedrons[ 9][3], 11);
    checkEqual(tetrahedrons[10][0],  5); checkEqual(tetrahedrons[10][1], 13); checkEqual(tetrahedrons[10][2],  6); checkEqual(tetrahedrons[10][3],  9);
    checkEqual(tetrahedrons[11][0],  6); checkEqual(tetrahedrons[11][1], 11); checkEqual(tetrahedrons[11][2],  2); checkEqual(tetrahedrons[11][3],  9);
    checkEqual(tetrahedrons[12][0], 11); checkEqual(tetrahedrons[12][1],  3); checkEqual(tetrahedrons[12][2],  2); checkEqual(tetrahedrons[12][3], 12);
    checkEqual(tetrahedrons[13][0],  5); checkEqual(tetrahedrons[13][1],  4); checkEqual(tetrahedrons[13][2], 13); checkEqual(tetrahedrons[13][3], 10);
    checkEqual(tetrahedrons[14][0],  0); checkEqual(tetrahedrons[14][1],  8); checkEqual(tetrahedrons[14][2],  4); checkEqual(tetrahedrons[14][3], 10);
    checkEqual(tetrahedrons[15][0],  1); checkEqual(tetrahedrons[15][1],  0); checkEqual(tetrahedrons[15][2], 10); checkEqual(tetrahedrons[15][3], 12);
    checkEqual(tetrahedrons[16][0],  8); checkEqual(tetrahedrons[16][1],  3); checkEqual(tetrahedrons[16][2], 11); checkEqual(tetrahedrons[16][3], 12);
    checkEqual(tetrahedrons[17][0],  8); checkEqual(tetrahedrons[17][1],  7); checkEqual(tetrahedrons[17][2], 13); checkEqual(tetrahedrons[17][3], 11);
    checkEqual(tetrahedrons[18][0],  6); checkEqual(tetrahedrons[18][1], 13); checkEqual(tetrahedrons[18][2], 11); checkEqual(tetrahedrons[18][3],  9);
    checkEqual(tetrahedrons[19][0], 11); checkEqual(tetrahedrons[19][1],  2); checkEqual(tetrahedrons[19][2],  9); checkEqual(tetrahedrons[19][3], 12);
    checkEqual(tetrahedrons[20][0],  5); checkEqual(tetrahedrons[20][1], 13); checkEqual(tetrahedrons[20][2],  9); checkEqual(tetrahedrons[20][3], 10);
    checkEqual(tetrahedrons[21][0],  4); checkEqual(tetrahedrons[21][1],  8); checkEqual(tetrahedrons[21][2], 13); checkEqual(tetrahedrons[21][3], 10);
    checkEqual(tetrahedrons[22][0],  9); checkEqual(tetrahedrons[22][1],  1); checkEqual(tetrahedrons[22][2], 10); checkEqual(tetrahedrons[22][3], 12);
    checkEqual(tetrahedrons[23][0],  0); checkEqual(tetrahedrons[23][1],  8); checkEqual(tetrahedrons[23][2], 10); checkEqual(tetrahedrons[23][3], 12);
