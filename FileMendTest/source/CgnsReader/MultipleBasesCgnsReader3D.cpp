...
struct MultipleBasesCgnsReader3DFixture {
    MultipleBasesCgnsReader3D multipleBasesCgnsReader3D = MultipleBasesCgnsReader3D(std::string(TEST_INPUT_DIRECTORY) +  "FileMend/MultipleBasesCgnsReader3D/110v_245e.cgns");
};

FixtureTestSuite(MultipleBasesCgnsReader3DSuite, MultipleBasesCgnsReader3DFixture)

TestCase(Base1Case) {
    this->multipleBasesCgnsReader3D.print();
