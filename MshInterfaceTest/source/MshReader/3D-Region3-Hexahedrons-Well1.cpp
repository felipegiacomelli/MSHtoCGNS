...
struct Read_Region1_Hexahedrons_Well1_3D_Fixture : public FixtureMshReader {
    Read_Region1_Hexahedrons_Well1_3D_Fixture() : FixtureMshReader("MshInterface/3D-Region3-Hexahedrons-Well1/88v_30e.msh") {}
};
